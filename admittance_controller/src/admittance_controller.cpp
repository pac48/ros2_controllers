...
//            for (int i =0 ; i < state_reference.positions.size(); i++) {
//                // add simple P control
//                state_reference.positions[i] +=  .5*(state_reference.positions[i] - state_current.positions[i]) - 1*state_current.velocities[i] ;
//            }
