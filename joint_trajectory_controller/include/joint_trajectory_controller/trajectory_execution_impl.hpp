...
//#include "../../../../../install/joint_limits/include/joint_limits/joint_limits.hpp"
...
namespace joint_trajectory_controller
{
    ...
    protected:
        ...
        using JointLimiter = joint_limits_interface::JointLimits;
        ...
        bool sample_trajectory(
                ...
                const std::unique_ptr<joint_limits_interface::JointLimits> & joint_limiter = nullptr)
        {
            return (*traj_point_active_ptr_)
                    ->sample(now, state_desired, start_segment_itr, end_segment_itr); //TODO last argument joint_limiter
        }
        ...
        rclcpp_action::GoalResponse goal_callback(
                ...
                bool allow_integration_in_goal_trajectories, const std::shared_ptr<rclcpp_lifecycle::LifecycleNode> node)
        {
        ...
        void feedback_setup_callback(
                ...
                std::shared_ptr<rclcpp_action::ServerGoalHandle<FollowJTrajAction>> goal_handle,
                std::shared_ptr<rclcpp_lifecycle::LifecycleNode> node, std::vector<std::string> joint_names,
                ...
                std::vector<std::string> joint_names, bool allow_integration_in_goal_trajectories)
        {
            ...
            action_server_ = rclcpp_action::create_server<FollowJTrajAction>(
                    ...
                    [=](const rclcpp_action::GoalUUID & tmp, std::shared_ptr<const FollowJTrajAction::Goal> goal) {
                        return TrajectoryExecutionImpl::goal_callback(tmp, goal, controller_interface, allow_partial_joints_goal, joint_names,allow_integration_in_goal_trajectories, node);
                    },
                    [this](std::shared_ptr<GoalHandle> gh) {
                        return TrajectoryExecutionImpl::cancel_callback(gh);
                    },
                    [=](std::shared_ptr<GoalHandle> gh) {
                        return  TrajectoryExecutionImpl::feedback_setup_callback(gh, node, joint_names, action_monitor_period);
                    }
                    );
